...
public class QRParkingService {
    ...
    public QRParking save(QRParkingDTO qrParkingDTO) {
        ...
        if (qrParkingFound != null) {
            ...
            qrParkingFound.setObservaciones("");
            qrParkingFound.setObservaciones(qrParkingDTO.getObservaciones());
    ...
    public DailyQROut generarCorteQRGeneral(String club, int idUsuario) {
        List<QRParking> qrParkingList = qrParkingRepository.findByClubAndDailyQROutIsNull(club);
